        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            {[
              ...
              { num: '02', title: 'Unreliable Movement',   body: 'Most transport has no scheduling or accountability. FeaziMove brings structure, safety, and predictability.' },
              ...
              { num: '04', title: 'Logistics Gaps',        body: 'Small businesses and individuals have no affordable, reliable way to move goods across the city. FeaziMove fills that gap by piggybacking deliveries on existing commuter routes.' },
