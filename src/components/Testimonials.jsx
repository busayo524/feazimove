...
const testimonials = [
  ...
  },
  {
    ...
    avatar: 'EN',
    rating: 5,
    text: 'FeaziSend is incredible for my business. I can send goods to my customers without hiring a separate delivery person. The tracking feature is top-notch and my customers love getting updates. Highly recommend.',
    color: 'bg-blue-500',
  },
  {
