  ...
  return (
    <div style={{ background: surface, border: `1px solid ${border}`, borderRadius: 16,
      ...
      <div style={{ padding: '14px 20px', borderBottom: `1px solid ${border}` }}>
        <p style={{ fontWeight: 700, fontSize: 13, color: MOSS, textTransform: 'uppercase',
        ...
        return (
          <button key={o.key} onClick={() => setTheme(o.key)} aria-pressed={on}
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ fontSize: 14.5, color: text, fontWeight: on ? 800 : 600 }}>{o.label}</p>
              <p style={{ fontSize: 12.5, color: muted, marginTop: 1 }}>{o.sub}</p>
            </div>
